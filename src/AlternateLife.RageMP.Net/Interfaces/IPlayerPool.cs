...
namespace AlternateLife.RageMP.Net.Interfaces
{
    public interface IPlayerPool : IPool<IPlayer>
    {
        ...
        /// <param name="dimension">Dimension to search players in</param>
        /// <exception cref="ArgumentNullException"><paramref name="message" /> is null (empty message is allowed)</exception>
        void Broadcast(string message, uint dimension);
        ...
        void Call(IEnumerable<IPlayer> players, string eventName, params object[] arguments);
        ...
        void Call(IEnumerable<IPlayer> players, string eventName, IEnumerable<object> arguments);
        ...
        /// <param name="arguments">Arguments of the event</param>
        /// <exception cref="ArgumentNullException"><paramref name="eventName" /> is null or empty</exception>
        void Call(Vector3 position, float range, uint dimension, string eventName, params object[] arguments);
        ...
        /// <param name="arguments">Arguments of the event</param>
        /// <exception cref="ArgumentNullException"><paramref name="eventName" /> is null or empty, <paramref name="arguments"/> is null</exception>
        void Call(Vector3 position, float range, uint dimension, string eventName, IEnumerable<object> arguments);
        ...
        /// <param name="arguments">Arguments of the event</param>
        /// <exception cref="ArgumentNullException"><paramref name="eventName" /> is null or empty</exception>
        void Call(uint dimension, string eventName, params object[] arguments);
        ...
        /// <param name="arguments">Arguments of the event</param>
        /// <exception cref="ArgumentNullException"><paramref name="eventName" /> is null or empty, <paramref name="arguments"/> is null</exception>
        void Call(uint dimension, string eventName, IEnumerable<object> arguments);
        ...
        /// <param name="nativeHash">Hash of the native</param>
        /// <param name="arguments">Arguments of the native</param>
        void Invoke(IEnumerable<IPlayer> players, ulong nativeHash, params object[] arguments);
        ...
        /// <param name="arguments">Arguments of the native</param>
        /// <exception cref="ArgumentNullException"><paramref name="arguments"/> is null</exception>
        void Invoke(IEnumerable<IPlayer> players, ulong nativeHash, IEnumerable<object> arguments);
        ...
        /// <param name="nativeHash">Hash of the native</param>
        /// <param name="arguments">Arguments of the native</param>
        void Invoke(Vector3 position, float range, uint dimension, ulong nativeHash, params object[] arguments);
        ...
        /// <param name="arguments">Arguments of the native</param>
        /// <exception cref="ArgumentNullException"><paramref name="arguments"/> is null</exception>
        void Invoke(Vector3 position, float range, uint dimension, ulong nativeHash, IEnumerable<object> arguments);
        ...
        /// <param name="nativeHash">Hash of the native</param>
        /// <param name="arguments">Arguments of the native</param>
        void Invoke(uint dimension, ulong nativeHash, params object[] arguments);
        ...
        /// <param name="arguments">Arguments of the native</param>
        /// <exception cref="ArgumentNullException"><paramref name="arguments"/> is null</exception>
        void Invoke(uint dimension, ulong nativeHash, IEnumerable<object> arguments);
