...
namespace AlternateLife.RageMP.Net.Interfaces
{
    public interface ITextLabelPool : IPool<ITextLabel>
    {
        ...
        ITextLabel New(Vector3 position, string text, uint font, Color color, float drawDistance = 20, bool los = false, uint dimension = MP.GlobalDimension);
        ...
        /// <returns>New <see cref="ITextLabel" /> instance</returns>
        /// <exception cref="ArgumentNullException"><paramref name="text"/> is null</exception>
        ITextLabel New(Vector3 position, string text, int font, Color color, float drawDistance = 20, bool los = false, uint dimension = MP.GlobalDimension);
